    ...
    <div class="container">
        <form method="POST" action="/updatecar/{{ $car->id }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-6 mt-5">
                    ...
                    <div class="mt-2">
                        ...
                        <input type="text" id="car_motorFuel" name="car_motorFuel" value="{{ $car->car_motorFuel }}"
                            required><br>
                    </div>
                    <div class="mt-2">
                        <label for="car_cylinder">{{ Lang::get('car.car_cylinder') }}</label><br>
                        <input type="number" id="car_cylinder" name="car_cylinder" value="{{ $car->car_cylinder }}"
                            required><br>
                    </div>
                    <div class="mt-2">
                    ...
                    <div class="mt-2">
                        ...
                        <input type="date" id="car_registration_date" name="car_registration_date"
                            value="{{ $car->car_registration_date }}" required><br>
                    </div>
                    <div class="mt-2">
		    ...
		    <div class="d-flex mt2">
                    	...
                    	<div class="ms-5 mt-4"><button class="btn btn-danger"><a class="text-decoration-none text-white"
                                href="{{ url('deleteallphotos/' . $car->id) }}">{{ Lang::get('car.car_deletePhotosButton') }}</a></button>
                    	</div>
	            </div>
                    <div class="mt-5">
                ...
                <div class="col-6 mt-5">
                    <div class="">
                        ...
                        <input type="number" id="car_horsePower" name="car_horsePower" value="{{ $car->car_horsePower }}"
                            required><br>
                    </div>
                    <div class="mt-2">
                    ...
                    <div class="mt-2">
                        ...
                        <input type="text" id="car_numberPlate" name="car_numberPlate"
                            value="{{ $car->car_numberPlate }}" required><br>
                    </div>
                    <div class="mt-2">
